...
# ==========================================
# 2. إصدار الفواتير والمطالبات
# ==========================================
with tabs[1]:
    if not s_data:
        # حماية: إذا ما في شقق مسجلة، بنعطيه تنبيه بدل الكراش
        st.warning("⚠️ لا يوجد أي شقق مسجلة في النظام. يرجى الذهاب للصفحة الرئيسية وإضافة شقة أولاً.")
    else:
        ...
        # ... باقي كود الفورم (with st.form) زي ما هو ...    
    if stds_in:
